...
- [*] **Copying other files:** Implement "copy newer" to recursively copy everything, that is not a web-component (exclude `comps` dir). To both the `step/` and `dist/` destinations.
